...
#         #super(PodcastFeed, self).__init__(*args, **kwargs)
    ...
    def add_root_elements(self, handler):
        ...
        pf_locked = f"yes"
        pf_locked_attr = {}
        if 'PODCAST_FEED_OWNER_EMAIL' in self.settings:
            pf_locked_attr = {'owner': self.settings['PODCAST_FEED_OWNER_EMAIL']}
        if 'PODCAST_FEED_LOCKED' in self.settings:
            if not self.settings['PODCAST_FEED_LOCKED']:
                pf_locked = f"no"
                pf_locked_attr = {}
...
class PodcastFeedGenerator(Generator):
    ...
    def generate_output(self, writer):
        ...
        podcast_feed_setting = [
            'PODCAST_FEED_PATH',
            'PODCAST_FEED_TITLE',
            'PODCAST_FEED_EXPLICIT',
            'PODCAST_FEED_LANGUAGE',
            'PODCAST_FEED_COPYRIGHT',
